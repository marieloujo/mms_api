...
class Contrat extends Pivot
{
    ...
    protected $fillable = [
        'numero_contrat','garantie', 'frais_dossier','prime','duree','numero_police_assurance','date_debut','date_echeance','date_effet','fin','date_fin','valider','client_id','marchand_id','assure_id',
    ];
    ...
    public function assure(){
        return $this->belongsTo('App\Models\Assurer','assure_id');
    }
