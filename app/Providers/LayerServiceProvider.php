...
class LayerServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('App\Services\UserableService', function (Application $app) {
            return new UserableService(
                $app->make('App\Repositories\UserableRepository')
            );
        });
        $this->app->bind(
            'App\Services\Contract\ServiceInterface\UserableServiceInterface',
            'App\Services\UserableService'
        );
	...
	$this->app->singleton('App\Services\ConversationService', function (Application $app) {
            return new ConversationService(
                $app->make('App\Repositories\ConversationRepository')
            );
        });
        $this->app->bind(
            'App\Services\Contract\ServiceInterface\ConversationServiceInterface',
            'App\Services\ConversationService'
        );

        $this->app->singleton('App\Services\ConversationUserService', function (Application $app) {
            return new ConversationUserService(
                $app->make('App\Repositories\ConversationUserRepository')
            );
        });
        $this->app->bind(
            'App\Services\Contract\ServiceInterface\ConversationUserServiceInterface',
            'App\Services\ConversationUserService'
        );



        $this->app->singleton('App\Services\MessageService', function (Application $app) {
            return new MessageService(
                $app->make('App\Repositories\MessageRepository')
            );
        });
        $this->app->bind(
            'App\Services\Contract\ServiceInterface\MessageServiceInterface',
