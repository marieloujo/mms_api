...
class MarchandService extends AbstractService implements MarchandServiceInterface
{
   ...
   public function getMarchand($matricule)
   {
       return Marchand::where('matricule',$matricule);
   }
   ...
   public function getWaitingContrats($marchand){
        return $this->read($marchand)->contrats()->where('valider',false)->orderByDesc('created_at')->paginate();
   }
}
